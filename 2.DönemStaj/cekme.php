                ...
                <div class="d-flex ml-auto flex-column flex-lg-row align-items-center">
                  <ul class="navbar-nav  ">
                    ...
                    <li class="nav-item active">
                      <a class="nav-link" href="giris2.php"> Para Yatırma </a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="giris2.php">Para Çekme</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="col-md-9 mx-auto">
              <div class="contact-form">
                <form action="" method="post">
                  ...
                  <br>
                    <input type="text" placeholder="Miktar" name="cekilecekTutar" onkeyup="">
                  </div>
                  <br>
                 
               </form>
              <p>Toplam Bakiyeniz: <span id="txtBakiye"></span></p>
      </div>
...
function loadDoc(str) {
  if (str.length == 0) {
    document.getElementById("txtBakiye").innerHTML = "";
    return;
  } else {
    const xmlhttp = new XMLHttpRequest();
    xmlhttp.onload = function() {
      document.getElementById("txtBakiye").innerHTML = this.responseText;
    }
